...
@Component({
  selector: 'app-student-name-correction',
  standalone: false,
  templateUrl: './student-name-correction.component.html',
  styleUrl: './student-name-correction.component.scss'
})
export class StudentNameCorrectionComponent {
 mobileNoChangeForm!: FormGroup;
  ...
  createForm() {
    this.mobileNoChangeForm = this.fb.group({
      // Student Details
      student_id: ['20210021', Validators.required],
      ...
      entrance_type_name_e: [{ value: '', disabled: true }],
      admission_quata: [{ value: '', disabled: true }],
      faculty_name_e: [{ value: '', disabled: true }],
      degree_programme_name_e: [{ value: '', disabled: true }],
      admitted_class: [{ value: '', disabled: true }],
      basic_category: [{ value: '', disabled: true }],
      veryfied_category: [{ value: '', disabled: true }],
